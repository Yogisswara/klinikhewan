    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
            ...
            <div class="space-y-6">
                <div class="flex items-center">
                    <span
                        class="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-green-400 to-teal-400">KlinikHewan</span>
                </div>
                <p class="text-gray-400 leading-relaxed">Memberikan pelayanan kesehatan berkualitas tinggi untuk hewan
                    kesayangan Anda dengan penuh kasih sayang dan profesionalisme.</p>
            ...
            <div>
                <h3 class="text-lg font-semibold text-white mb-6 border-b border-gray-700 pb-2">Tautan Cepat</h3>
                <ul class="space-y-3">
                    <li>
                        <a href="{{ route('home') }}"
            ...
            <!-- Bagian 3 - Services -->
            <div>
                <h3 class="text-lg font-semibold text-white mb-6 border-b border-gray-700 pb-2">Layanan Kami</h3>
                <ul class="space-y-3">
                    <li>
                        <a href="#"
                            class="text-gray-400 hover:text-white transition-colors duration-300 flex items-center">
            ...
            <!-- Bagian 4 - Contact -->
            <div>
                <h3 class="text-lg font-semibold text-white mb-6 border-b border-gray-700 pb-2">Hubungi Kami</h3>
                <ul class="space-y-4">
                    <li class="flex items-start">
                        <svg class="flex-shrink-0 h-5 w-5 text-green-400 mt-0.5" fill="none" stroke="currentColor"
                            viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <span class="ml-3 text-gray-400">Jl. Contoh No. 123<br>Jakarta, Indonesia</span>
                    </li>
                    <li class="flex items-center">
                        <svg class="flex-shrink-0 h-5 w-5 text-green-400" fill="none" stroke="currentColor"
                            viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                        </svg>
                        <span class="ml-3 text-gray-400">+62 123 4567 890</span>
                    </li>
                    <li class="flex items-center">
                        <svg class="flex-shrink-0 h-5 w-5 text-green-400" fill="none" stroke="currentColor"
                            viewBox="0 0 24 24">
                        ...
                        <span class="ml-3 text-gray-400">info@klinikhewan.com</span>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="mt-12 pt-8 border-t border-gray-800 text-center">
            <p class="text-gray-500 text-sm">
                &copy; {{ date('Y') }} KlinikHewan. Semua hak dilindungi.
